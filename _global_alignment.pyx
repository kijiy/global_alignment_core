...
def align(char *x, char *y, int match, int mis_match, int gap_extension, int gap_start, int end_weight, int grs, int gre):
    ...
    arrx = arrx[:n][::-1]
    arry = arry[:n][::-1]
    return M, P, Q, max(M[lx,ly], P[lx,ly], Q[lx,ly]), arrx, arry
